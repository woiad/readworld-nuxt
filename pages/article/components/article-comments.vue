  ...
  <div>
    <form class="card comment-form">
      ...
      <div class="card-footer">
        ...
        <button class="btn btn-sm btn-primary" :disabled="commentLoading" @click.prevent="submitComment">
          Post Comment
        </button>
      </div>
    </form>
    <div class="card" v-for="comment in comments" :key="comment.id">
      ...
      <div class="card-footer">
        <nuxt-link :to="{namae: 'profile', params: { username: comment.author.username }}" class="comment-author">
